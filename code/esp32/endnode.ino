 ...
 *
 *******************************************************************************/
#include <lmic.h>     // Lib for LoRaWAN communication
#include <hal/hal.h> // Lib for LoRaWAN communication
#include <SPI.h>    // Lib for SPI protocol
#include "pitches.h" // Lib for Piezo buzzer
